...
service_one = Service.create(name: "Comptabilité", description: "Nous tenons votre comptabilité et faisons le lien avec l'expert comptable")
...
service_two = Service.create(name: "Suivi des ventes", description:"Nous gérons votre facturation clients et mettons en place des indicateurs de suivi")
...
service_three = Service.create(name: "Gestion administrative", description: "Nous nous occupons de vos démarches administratives et assurons leur suivi")
